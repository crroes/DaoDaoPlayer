//package com.cross.fxwiz_widget_jpush;
//
...
//	  mSettings = getSharedPreferences(JPushUtils.PREFS_NAME, MODE_PRIVATE);
//	  String days = mSettings.getString(JPushUtils.PREFS_DAYS, "");
...
//		}
//
//	  int startTimeStr = mSettings.getInt(JPushUtils.PREFS_START_TIME, 0);
//	  startTime.setCurrentHour(startTimeStr);
//	  int endTimeStr = mSettings.getInt(JPushUtils.PREFS_END_TIME, 23);
...
//		mEditor.putString(JPushUtils.PREFS_DAYS, daysSB.toString());
//		mEditor.putInt(JPushUtils.PREFS_START_TIME, startime);
//		mEditor.putInt(JPushUtils.PREFS_END_TIME, endtime);
//		mEditor.commit();
