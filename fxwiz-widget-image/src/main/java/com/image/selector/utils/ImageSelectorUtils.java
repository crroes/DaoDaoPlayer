...
import com.image.selector.ClipImageActivity;
import com.image.selector.ImageSelectorActivity;
...
public class ImageSelectorUtils {
    ...
    public static void openPhoto(Fragment fragment, int requestCode,
                                 boolean isSingle, int maxSelectCount, ArrayList<String> selected) {
        ImageSelectorActivity.openActivity(fragment, requestCode, isSingle, maxSelectCount, selected);
    }
